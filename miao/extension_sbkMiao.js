        ...
        if(typeof map[id].shanRequired=='number'){
            ...
            map[id].shanRequired=3;
				...
				translate: {
					...
					"sup_luoshen": "洛神",
					"sup_luoshen_info":
						"锁定技，准备阶段，若当前轮数为2的倍数，你失去一点体力上限，否则你回复一点体力。然后你进行判定，若结果不为红桃则获得此判定牌，且可重复此流程至多10次直到出现红桃的判定结果。你通过〖洛神〗获得的牌，不计入当前回合的手牌上限",
					"sup_qinguo": "倾国",
					...
					"sup_jueqing": "绝情",
					"sup_jueqing_info": "锁定技，你即将造成伤害时，你令目标角色失去1点体力。",
					"sup_shangshi": "伤逝",
